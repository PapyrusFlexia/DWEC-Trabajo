...
let juego1 = new Juego("DnD", creador1, "Fantasía", editorial1, "xd1");
let juego2 = new Juego("La llamada de Cthulhu", creador2, "Misterio", editorial2, "x2d");
let juego3 = new Juego("Weegee", creador3, "Ciencia Ficcion", editorial3, "x4d");
let juego4 = new Juego("Heehee", creador4, "Terror", editorial4, "x3d");
let juego5 = new Juego("Referencia Entendida", creador5, "Sci-Fi", editorial5, "x5d");
let juego6 = new Juego("Aw Shit Here We Go Again", creador6, "Estrategia", editorial6, "x1d");
let juego7 = new Juego("La Marca Del Este", creador7, "Fantasía", editorial7, "x23d");
let juego8 = new Juego("El Cero", creador3, "Misterio", editorial2, "x143d");
let juego9 = new Juego("La Ciudad de la Locura", creador1, "Terror", editorial1, "x43d");
let juego10 = new Juego("Fate", creador8, "Fantasía", editorial8, "x23d");
let juego11 = new Juego("Fate Acelerado", creador8, "Estrategia", editorial8, "x12d");
let juego12 = new Juego("Pipo", creador9, "Misterio", editorial9, "x44d");
let juego13 = new Juego("Yeetus Deletus", creador9, "Sci-Fi", editorial9, "x33d");
let juego14 = new Juego("Age of Empires", creador2, "Estrategia", editorial2, "x22d");
let juego15 = new Juego("Chainmail", creador1, "Fantasía", editorial4, "x11d");
