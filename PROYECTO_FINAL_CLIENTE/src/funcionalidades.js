/**
 * Funcion que recibe una cadena, le quita los espacios en blanco por delante y por detras y la pone en mayusculas, devuelve el array resultante
...
/**
 * Funcion que recibe dos nodos y que sirve para validar si un input contiene un titulo y devuelve el titulo validado
...
/**
 * Funcion que recibe dos nodos y que sirve para validar si un juego se ha cambiado y devuelve el juego editado
...
/**
 * Funcion que recibe dos nodos y que sirve para validar las opciones seleccionadas y devuelve la opción seleccionada validada
...
/**
 * Funcion que recibe dos nodos y que sirve para validar si un input contiene el nombre de un creador y devuelve el nombre del creador validado
...
/**
 * Funcion que recibe dos nodos y que sirve para validar si un input contiene el apellido de un creador y devuelve el apellido del creador validado
...
/**
 * Funcion que recibe dos nodos y valida el nombre del usuario y devuelve el nombre de usuario validado
...
/**
 * Funcion que recibe dos nodos y valida el genero y devuelve el genero validado
...
/**
 * Funcion que recibe dos nodos y que sirve para validar si un input contiene un nombre de una editorial y devuelve el nombre de la editorial validada
...
/**
 * Funcion que recibe dos nodos y que sirve para quitar los espacios en un array y devuelve el array sin espacios
...
/**
 * Funcion que recibe dos nodos y que sirve para validar la longitud y devuelve la longitud minima validada
...
/**
 * Funcion que recibe dos nodos y que sirve para validar el juego seleccionado y devuelve el juego validado seleccionado
