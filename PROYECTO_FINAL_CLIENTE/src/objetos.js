...
let juego1 = new Juego("DnD", creador1, "Fantasía", editorial1, "PapyrusFlexia");
let juego2 = new Juego("La llamada de Cthulhu", creador2, "Misterio", editorial2, "Fabuland");
let juego3 = new Juego("Weegee", creador3, "Ciencia Ficcion", editorial3, "Dio");
let juego4 = new Juego("Heehee", creador4, "Terror", editorial4, "Jotaro");
let juego5 = new Juego("Referencia Entendida", creador5, "Sci-Fi", editorial5, "Josuke");
let juego6 = new Juego("Aw Shit Here We Go Again", creador6, "Estrategia", editorial6, "Giorno");
let juego7 = new Juego("La Marca Del Este", creador7, "Fantasía", editorial7, "Diavolo");
let juego8 = new Juego("El Cero", creador3, "Misterio", editorial2, "SukuBlyat");
let juego9 = new Juego("La Ciudad de la Locura", creador1, "Terror", editorial1, "Alexelcapo");
let juego10 = new Juego("Fate", creador8, "Fantasía", editorial8, "DalasTeDenuncia");
let juego11 = new Juego("Fate Acelerado", creador8, "Estrategia", editorial8, "PS1Hagrid");
let juego12 = new Juego("Pipo", creador9, "Misterio", editorial9, "MeAndTheBoys");
let juego13 = new Juego("Yeetus Deletus", creador9, "Sci-Fi", editorial9, "Nigerundayo");
let juego14 = new Juego("Age of Empires", creador2, "Estrategia", editorial2, "Dingus");
let juego15 = new Juego("Chainmail", creador1, "Fantasía", editorial4, "Yingus");
